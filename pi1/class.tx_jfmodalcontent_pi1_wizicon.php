 ...
 */
class tx_jfmodalcontent_pi1_wizicon
{
	/**
	...
	function proc($wizardItems)
	{
		...
		$wizardItems['plugins_tx_jfmodalcontent_pi1'] = array(
			...
			'params' => '&defVals[tt_content][CType]=list&defVals[tt_content][list_type]=jfmodalcontent_pi1'
		);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfmodalcontent/pi1/class.tx_jfmodalcontent_pi1_wizicon.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfmodalcontent/pi1/class.tx_jfmodalcontent_pi1_wizicon.php']);
}
